...
const Politicas = () => {
    return (
        <Container>
            <Head>
                <title>MÖA-Politicas</title>
            </Head>

            <div className="main">
                <img src="T15.png" alt="politicas de privacidad" className="title" />
                <div className="container">
                    ...
                    <p>
                        ...
                        algún beneficio, estos correos electrónicos serán enviados a la dirección que usted proporcione y podrán ser
                        cancelados en cualquier momento.

                    </p>
                    <p>
                        Albert Guillén Group está altamente comprometido para cumplir con el compromiso de mantener su información segura.
                    ...
                    <p>
                        ...
                        y también facilita las futuras visitas a una web recurrente. Otra función que tienen las cookies es que con ellas las web
                    ...
                    <p>
                        ...
                        las cookies en cualquier momento desde su ordenador. Sin embargo las cookies ayudan a proporcionar un mejor servicio de los
                    ...
                    <p>
                        Usted puede aceptar o negar el uso de cookies, sin embargo la mayoría de navegadores aceptan cookies automáticamente pues sirve
                        para tener un mejor servicio web. También usted puede cambiar la configuración de su ordenador para declinar las cookies.
                    ...
                    <p>
                        ...
                        información por correo electrónico. En caso de que haya marcado la opción de recibir nuestro boletín o publicidad usted
                    ...
                    <p>
                        Albert Guillén Group se reserva el derecho de cambiar los términos de la presente Política de Privacidad en cualquier
                        momento.his Privacy Policy at any time.
                    </p>
                </div>
